...
import ding.co.backendportfolio.chapter5._2_bulk_operation.*;
...
@Component
public class SubwayStatBatchApplicationImproved {
    ...
    public void bulkDeleteImproved() {
        // HTTP 요청으로 처리되지 않는다고 가정하고 수동으로 BatchContext를 초기화
        BatchContextHolder.initContext(new BatchContext(BatchName.IMPROVED_BULK_DELETE));
