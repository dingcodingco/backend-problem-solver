...
public class BoardAnalyticsBenchmark {
    ...
    public void setup() {
        ...
        boardAnalyticsService = new BoardAnalyticsService(boardRepository, boardTagRepository);
    ...
    @Benchmark
    public Map<String, Object> benchmarkGenerateBoardStatistics() {
        return boardAnalyticsService.generateBoardStatistics(1L);
    }
} 